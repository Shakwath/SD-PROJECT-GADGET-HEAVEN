  ...
  return (
    <div className="container mx-auto p-10 card card-bordered my-5 text-[#ffffff] bg-gradient-to-r from-[#9538e2d8] via-[#9766be] to-[#ba90f5] ">
      <div className="container mx-auto p-6 ">
        <h1 className="text-4xl card-title  font-bold mb-6">Contact with Us</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          <div>
            ...
            <div className="mb-4">
              ...
              <p>Head Office: 28 Kazi Nazrul Islam <br />
                Ave,Navana Zohura Square, Dhaka 1000</p>
            </div>
    <nav>
          ...
          <div>
            ...
            <form className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full p-3 bg-violet-900 text-white font-semibold rounded-md hover:bg-violet-950">
                  Send Message
                </button>
              </div>
            </form>
